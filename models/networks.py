...
class NGP(nn.Module):
    ...
    def __init__(self, scale=0.5, black_bg=False):
        super().__init__()
    ...
    def update_density_grid(self,
        ...
        self.density_grid = torch.where(
            self.density_grid < 0, self.density_grid,
    ...
    @torch.no_grad()
    def reset_density_field(self):
        """Reset to all_zeros."""
        self.density_grid.fill_(0.)
        self.density_bitfield.fill_(0)
